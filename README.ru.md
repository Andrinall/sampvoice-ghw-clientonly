# **SAMPVOICE** - [Оригинальный репозиторий](https://github.com/CyberMor/sampvoice/blob/master/README.ru.md)
...
## Установка
---------------------------------
Для работы плагина, его необходимо установить игрокам и на сервер. Для этого есть [клиентская](../../releases) и [серверная](https://github.com/AmyrAhmady/sampvoice/) части плагина.
...
##### Ручной вариант
---------------------------------
1. Перейдите по [ссылке](../../releases) и скачайте архив с необходимой версией клиента.
