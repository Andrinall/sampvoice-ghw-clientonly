# **SAMPVOICE**
[Оригинальный репозиторий](https://github.com/CyberMor/sampvoice/blob/master/README.ru.md)
[English](https://github.com/Andrinall/sampvoice-ghw-clientonly/blob/master/README.md) | Русский
...
#### Поддержка версий
----------------------------------
* Клиент: SA:MP 0.3.7 (R1, R3), SA:MP 0.3.DL (R1)
* Сервер: SA:MP 0.3.7 (R2), SA:MP 0.3.DL (R1), O-MP ( build beta 5 - 9 )
...
## Установка
---------------------------------
Для работы плагина, его необходимо установить игрокам и на сервер. Для этого есть [клиентская](https://github.com/Andrinall/sampvoice-ghw-clientonly) и [серверная](https://github.com/AmyrAhmady/sampvoice/) части плагина.

#### Для игроков
---------------------------------
Игрокам доступнен 1 вариант установки: ручной (через архив).

##### Ручной вариант
---------------------------------
1. Перейдите по [ссылке](https://github.com/Andrinall/sampvoice-ghw-clientonly/releases) и скачайте архив с необходимой версией клиента.
